...
void BTTask::_bind_methods()
{
	...
	ClassDB::bind_method(D_METHOD("add_child_at_index", "task", "index"), &BTTask::add_child_at_index);
    ...
    ClassDB::bind_method(D_METHOD("set_children", "actor"), &BTTask::set_children);
